  ...
  try {
    ...
    const poeChecklist = await prisma.pOEChecklist.create({
      data: {
        ...
        assessmentsSigned: body.assessmentSigned || body.assessmentsSigned || false,
        logbookComplete: body.logbookComplete || false,
        logbookSigned: body.logbookSigned || false,
        idCopyPresent: body.idCopy || body.idCopyPresent || false,
