...
const modulesData = [
    {
        ...
        unitStandards: [
            ...
            { code: '7469', title: 'Use mathematics to investigate and monitor the financial aspects of personal and community life', credits: 2, level: 2, type: 'Fundamental' },
    ...
    },
    {
        ...
        fullName: 'Apply Basic Communication Skills in New Venture Creation Context',
        purpose: 'Equip learners with the necessary communication skills and knowledge to successfully interact with employees, clients and suppliers.',
        credits: 24,
        notionalHours: 240,
        classroomHours: 72,
        workplaceHours: 168,
    ...
    },
    {
        ...
        unitStandards: [
            ...
            { code: '119670', title: 'Produce a business plan for a new venture', credits: 5, level: 3, type: 'Core' },
