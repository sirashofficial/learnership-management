...
- [ ] Assessment status transitions work (not_started → in_progress → completed)
...
3. Mark assessments progressively (formative → summative)
...
### Success Criteria
- ✓ All 9 test phases pass (100% pass rate)
- ✓ No TypeScript errors on any page
- ✓ All API endpoints return correct status codes
- ✓ Data persistence verified (created data retrieves correctly)
- ✓ All three pages load without errors
- ✓ Assessment moderation workflow complete
- ✓ Reports generate successfully
- ✓ Timetable displays all scheduled lessons
